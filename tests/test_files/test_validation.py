...
def test_validate_regex():
    ...
    toml_file_directory_valid = os.path.abspath(
        os.path.join(current_file_directory, "..", "toml_files/regexp/valid")
    )
    toml_file_directory_invalid = os.path.abspath(
        os.path.join(current_file_directory, "..", "toml_files/regexp/invalid")
    )
